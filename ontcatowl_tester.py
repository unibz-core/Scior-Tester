...
from modules.build.build_directories_structure import get_list_unhidden_directories, \
    create_test_directory_folders_structure, create_internal_catalog_path
from modules.build.build_taxonomy_files import create_taxonomy_ttl_files
...
def build_ontcatowl_tester(catalog_path):
    ...
    for dataset in list_datasets:
        ...
        create_taxonomy_ttl_files(source_owl_file_path, dataset_folder_path, catalog_size, current)
