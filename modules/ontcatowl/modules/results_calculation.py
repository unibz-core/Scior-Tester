...
from modules.ontcatowl.modules.results_classes import dataclass_statistics, classes_statistics, \
    classifications_statistics, list_classes_by_situation, consolidated_statistics
